 ...
 *
 */
public class PhoenixLoginComposite extends AbstractLoginComposite {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(PhoenixLoginComposite.class);
	 ...
	 */
	public PhoenixLoginComposite(Composite parent, int style, List<String> listGroupName, String selGroupName, UserDBDAO userDB, boolean isReadOnly) {
		super("Sample Apache Hive", DBDefine.HIVE_DEFAULT, parent, style, listGroupName, selGroupName, userDB, isReadOnly);
	}
	
	public PhoenixLoginComposite(String strDisplayName, DBDefine selectDB,
