...
import com.hangum.tadpole.rdb.core.dialog.dbconnect.composite.PhoenixLoginComposite;
...
//			loginComposite = new AWSRDSLoginComposite(compositeBody, SWT.NONE, listGroupName, selGroupName, userDB, isReadOnly);
			...
			loginComposite = new PhoenixLoginComposite(compositeBody, SWT.NONE, listGroupName, selGroupName, userDB, isReadOnly);
		}
